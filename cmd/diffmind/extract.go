...
import (
	...
	"github.com/mohammad-safakhou/diffmind/internal/extractor/ui"
...
func serveExtractorUI(args []string) {
	fs := flag.NewFlagSet("extractor-ui", flag.ExitOnError)
	baseDir := fs.String("out", "", "artifact base directory (default ~/.diffmind/runs)")
	...
	if distDir := extractorEnsureSPABuilt(*noSPARebuild); distDir != "" {
