...
> **Historical, superseded roadmap.** This document discusses the removed
> LLM/detail stages. Use [current architecture](../../ARCHITECTURE.md) and
> [the product roadmap](../../ROADMAP.md) for current priorities.
