...
func requireSCIPIntegration(t *testing.T) {
	t.Helper()
	if os.Getenv("DIFFMIND_RUN_SCIP_INTEGRATION") != "1" {
		t.Skip("set DIFFMIND_RUN_SCIP_INTEGRATION=1 to run external SCIP indexer tests")
	}
}
