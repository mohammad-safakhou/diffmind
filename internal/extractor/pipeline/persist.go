...
import (
	...
	"github.com/mohammad-safakhou/diffmind/internal/extractor/runstate"
...
func renderFailureMarkdown(f *Failure, runDir string) string {
	...
	if f.ErrorClass == "schema" {
		fmt.Fprintf(&b, "\n> Tip: validate the generated Protocol JSON and detector output for missing required fields or invalid references.\n")
	}
	return b.String()
}
