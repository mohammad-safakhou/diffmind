...
func protocolEncodeJSON(w io.Writer, doc *protocol.Document) error {
	return protocol.EncodeJSON(w, doc)
}
func protocolEncodeYAML(w io.Writer, doc *protocol.Document) error {
	return protocol.EncodeYAML(w, doc)
}
...
func buildProtocol(in WriteInput, manifest model.RunManifest) (*protocol.Document, error) {
...
func sortProtocol(doc *protocol.Document) {
...
func canonicalizeProtocol(doc *protocol.Document) {
	if doc.Flows == nil {
