...
func TestNormalizeServiceNameCollapsesPath(t *testing.T) {
	cases := map[string]string{
		"/path/to/repos/payments":  "payments",
		"/path/to/repos/payments/": "payments",
		"payments":                 "payments",
		"  payments  ":             "payments",
		"":                         "",
...
func TestEntityCatalogKeyMatchesRunAndFileService(t *testing.T) {
	...
	runFact := model.BaseEntity{Type: "db_operation", Name: "read campaign_item", Service: "/path/to/repos/routing-service", Platform: "postgres", Details: details}
