...
func (s *CheckpointStore) AppendDiscoveryShard(objID string, shardIndex int, items []LLMEntity) {
...
func (s *CheckpointStore) LoadDiscoveryShardCheckpoint(dir, objID string) map[int][]LLMEntity {
