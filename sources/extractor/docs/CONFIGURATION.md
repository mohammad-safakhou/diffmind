...
| `service_ref` | DiffMind protocol service ref, usually `service.<service-id>`. Required. |
...
| `resource_ref` | DiffMind protocol resource ref. |
...
- Do not put generated DiffMind protocol content in this file.
