...
DiffMind protocol is the Diffmind Service Context Protocol.
...
DiffMind writes DiffMind protocol. DiffMind reads DiffMind protocol.
...
DiffMind protocol separates four concepts:
...
- imports this module,
- builds a DiffMind protocol document from deterministic findings,
- writes `.diffmind/context/service.json`.

DiffMind:

- imports this module,
- reads DiffMind protocol documents from DiffMind run directories,
- builds the company graph from service objects, resources, calls, and flows.

DiffMind protocol itself has no UI and does not scan repositories.
